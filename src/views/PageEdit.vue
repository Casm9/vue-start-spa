<template>
    ...
    <form action="" class="container mb-3">
        <div class="row">
            <div class="col-md-8">
                ...
                <div class="mb-3">
                    ...
                    <textarea type="text" class="form-control" row="5" v-model="page.content"></textarea>
                </div>
            </div>
            <div class="col">
                <div class="mb-3">
        ...
        <div class="mb-3">
            ...
            <button class="btn btn-secondary me-2" @click.prevent="goToPagesList">Cancel</button>
